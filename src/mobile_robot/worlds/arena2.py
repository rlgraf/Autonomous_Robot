...
"""
gen_arena_world.py
Generates arena_generated.sdf — the existing 50x50 arena with 4 randomly
placed static cylinders injected.  Safe spawn zone around (0,0) is enforced.

Usage:
    python3 gen_arena_world.py --out /tmp/arena_generated.sdf [--seed 42]
"""
